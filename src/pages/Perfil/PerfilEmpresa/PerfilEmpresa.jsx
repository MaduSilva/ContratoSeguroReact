    ...
    return (
        <div>
            ...
            {Object.values(data).map(empresa => (
                <div key={empresa.empresa} style={{width: "200px",  boxShadow:"1px 1px 1px px  gray", height:"30px" , display:"flex", justifyContent:"center", marginTop:"50px" }}>
                <h1 style={{fontSize:"18px", marginTop:"5px"}}>{empresa.nome}</h1>
                </div>
                ))}
